    ...
    <body>
        ...
        <div class="Homescreen" style="position: relative; top: -10px">
            ...
            <div class="topMenu">
                ...
                <%
                    session.setAttribute("uname", request.getAttribute("name")); 
                %>
                ...
                <div class="Foodtab">       
                  ...
                  <h1 class="browseT" style="  font-family: 'Josefin Sans', sans-serif;">Browse for food! </h1>
                        ...
                        <div class="sibling-fade">
                            ...
                            <a href="food.jsp#drinks" style="text-decoration: none" class="drinkIcon"> <br> Beverages</a>
                            <a href="food.jsp#bakery" style="text-decoration: none" class="breadIcon"> <br> Bakery</a>
                            <a href="food.jsp#snack" style="text-decoration: none" class="snackIcon"> <br> Snacks</a>
                        </div>
                </div>
